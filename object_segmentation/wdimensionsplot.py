...
ax1.set_title("Dominant Frequency (Hz): Predicted vs Recorded (Given Object Dimensions)", fontsize=14, fontweight='bold')
...
ax2.set_title("Intensity (dB): Predicted vs Recorded (Given Object Dimensions)", fontsize=14, fontweight='bold')
ax2.legend(loc='upper left', fontsize=10)
ax2.grid(True, alpha=0.3, axis='y')

plt.tight_layout()
plt.savefig('vlm_acoustic_comparison_no_dimensions.png', dpi=300, bbox_inches='tight')
plt.show()